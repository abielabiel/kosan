...
<div class="container">
    ...
    <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            <form method="post" action="/booking/simpan">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="id_penyewa" class="form-control">
                        <option value="">-- Pilih NamaPenyewa --</option>
                        @foreach($penyewa as $penyewa)
                            <option value="{{ $penyewa->id_penyewa }}">{{ $penyewa->id_penyewa }} - {{ $penyewa->name }}</option>
                        @endforeach
                    </select>
                    @error('id_penyewa')
