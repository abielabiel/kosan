...
<div class="row">
    ...
    <div class="col-md-9">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <a href="/penyewa/tambah" class="btn btn-soft-pink">Input Data Baru</a>
                    <br/>
                    <br/>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $g->alamat }}</td>
                                <td> 
                                    <a href="/penyewa/edit/{{ $g->id_penyewa }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>Edit
                                    </a>

                                    <a href="/penyewa/hapus/{{ $g->id_penyewa }}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Mau Hapus Data?')">
